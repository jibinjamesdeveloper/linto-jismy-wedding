      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto', position: 'relative' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'clamp(180px,32%,300px) 1fr', gap: 'clamp(2rem,5vw,4rem)', alignItems: 'start' }} className="details-grid">
          ...
          <div className="reveal-right" style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
            ...
            <a href="https://maps.google.com/?q=Lourdes+Matha+Church+Parish+Hall+Mampuzhakary+Kerala"
              target="_blank" rel="noopener noreferrer"
              style={{
                display: 'inline-flex', alignItems: 'center', gap: '0.6rem',
                fontFamily: 'Montserrat, sans-serif', fontSize: '0.6rem', letterSpacing: '0.2em',
                textTransform: 'uppercase', fontWeight: 600,
                color: 'var(--deep-rose)', textDecoration: 'none',
                border: '1.5px solid rgba(122,53,53,0.32)',
                borderRadius: '100px', padding: '0.75rem 1.8rem',
                alignSelf: 'flex-start', marginTop: '0.4rem',
                background: 'rgba(253,246,238,0.5)',
                transition: 'all 0.3s',
              }}
              onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = 'rgba(122,53,53,0.07)'; }}
              onMouseLeave={e => { (e.currentTarget as HTMLElement).style.background = 'rgba(253,246,238,0.5)'; }}
            >
