...
function BirthdaySection() {
  ...
  return (
    <>
      ...
      {/* Birthday countdown cards */}
      <div className="reveal" style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '1rem', marginBottom: '3rem' }}>
        {BIRTHDAYS.map(b => {
...
export default function OurStorySection() {
  ...
  return (
    <section id="story" ref={ref} style={{ background: 'var(--ivory)', padding: '7rem 1.5rem 6rem', position: 'relative', overflow: 'hidden' }}>
