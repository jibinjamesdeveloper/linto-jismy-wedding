      ...
      {prompt && !playing && (
        <button onClick={toggle} style={{
          ...
          <span style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', lineHeight: 1.1 }}>
            <span style={{ fontFamily: 'Dancing Script, cursive', fontSize: '1.08rem', fontWeight: 700 }}>Tap for music</span>
            <span style={{ fontFamily: 'Montserrat, sans-serif', fontSize: '0.46rem', letterSpacing: '0.16em', textTransform: 'uppercase', color: '#b8904a', marginTop: '0.18rem' }}>Perfect - Ed Sheeran</span>
          </span>
        </button>
      )}
