...
export default function HeroSection() {
  ...
  useEffect(() => {
    const fn = () => { if (window.scrollY < window.innerHeight * 1.5) setScrollY(window.scrollY); };
  ...
  return (
    <section id="home" style={{ position: 'relative', minHeight: '100vh', display: 'flex', alignItems: 'stretch', overflow: 'hidden' }}>

      {/* ── Background photo — sharp, no blur ── */}
      <div style={{ position: 'absolute', inset: 0, transform: `translateY(${parallax}px) scale(1.1)`, transformOrigin: 'center top' }}>
        <Image
        ...
        <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(175deg, rgba(248,232,220,0.38) 0%, rgba(240,218,200,0.52) 50%, rgba(249,242,232,0.9) 100%)' }} />
        <div style={{ position: 'absolute', inset: 0, background: 'radial-gradient(ellipse 100% 80% at 50% 30%, transparent 35%, rgba(92,32,32,0.1) 100%)' }} />
      </div>
      ...
      {/* ── Main content ── */}
      <div style={{ position: 'relative', zIndex: 2, width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', padding: '6rem 1.5rem 4rem', opacity: fade }}>

        {/* Eyebrow label */}
        <div style={{ ...T(80), display: 'flex', alignItems: 'center', gap: '1.2rem', marginBottom: '2rem' }}>
        ...
        <div style={{ ...T(540), display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '3rem' }}>
        ...
        {/* Info cards */}
        <div style={{ ...T(660), display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '0.8rem', marginBottom: '3.5rem' }}>
          {[
        ...
        {/* CTAs */}
        <div style={{ ...T(780), display: 'flex', gap: '1rem', flexWrap: 'wrap', justifyContent: 'center', marginBottom: '5rem' }}>
          <a href="#story" style={{
        ...
        {/* Scroll cue */}
        <div style={{ opacity: visible ? 0.45 : 0, transition: 'opacity 1s ease 1.4s', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px' }}>
